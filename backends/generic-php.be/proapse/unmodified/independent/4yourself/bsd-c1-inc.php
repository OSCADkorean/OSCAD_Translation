...
$gFbLiSpUcDesc=
"BSD로 라이선스 된 받은 소프트웨어를 단독으로 사용하고 제3자에게 양도하지 않으려 하는 의도
를 갖고 있다";
...
$gFbLiSpUcNoTasks=
"제3자에게 소프트웨어를 제공하지 않는 한 어떠한 의무가 부과되지 않고, 어떠한 정황에서 어떠한
유형의 BSD 소프트웨어를 사용할 수 있다.";
...
Clause License에 의해 자신의 저작물을 홍보하기 위해 라이선싱 기관명 또는 라이선싱 기여자
(licensing contributor)명 사용이 명백히 금지된다."
);
?>
