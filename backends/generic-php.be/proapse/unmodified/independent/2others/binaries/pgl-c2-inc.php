...
*/
" PGL로 라이선스 된 받은 소프트웨어의 비수정 버전을 바이너리 형태로 또는 소스코드 파일로 제3자에게 배포하고자 하는 의도를 갖고 있다. 이 경우 프로그램, 어플리케이션, 서버, 스니펫, 모듈, 라이브러리, 플러그 또는 독립패키지 등 배포유형을 식별하는 것은 아니다.";
...
*/
" 저작권 공지, 허가 공지 및 PGL 권리포기사항을 포함하여 Postgres 라이선스를 받았던형태로 패키지에 전부 보유한다.");
