...
$gOsLicLsucChapter="6.11.1";
$gOsLicTlExplanationChapter="6.11.10";

$gFbLiSpUcName="MPL-2.0-C1";
...
$gFbLiSpUcDesc=
  ...
  "MPL-2.0으로 라이선스 된 받은 소프트웨어를 단독으로 사용하고 제3자에게 양도하지 않는 의도를 갖고 있다.";
  

$gFbLiSpUcRequiresPrefix=
	/*"no tasks in order to fulfill the conditions of the MPL-2.0
license with respect to this use case:";*/

"다음 사용 사례에 관련하여 MPL-2.0 라이선스 조건을 충족하기 위한 작업은 없다:";

$gFbLiSpUcNoTasks=

	/*"You are allowed to use any kind of MPL-2.0 software in any sense and in
    any context without being obliged to do anything as long as you do not
    give the software to 3rd parties.";*/
	
	"제3자에게 소프트웨어를 제공하지 않는 한 어떠한 의무가 부과되지 않는 사용상황에서 어떠한 유형의 MPL-2.0 소프트웨어를 사용할 수 있다.";
