...
$gFbLiSpUcDesc=
  ...
  "PHP-3.0으로 라이선스 된 받은 프로그램, 어플리케이션 또는 서버 등 프로앱스의 수정 버전을 바이너리 파일 형태 또는 바이너리 패키지로 제3자에게 배포하려는 의도를 갖고 있다.";
...
$gFbLiSpUcRequiresVolArr=array(
  ...
  disclaimer.",
		...
		"전체 PHP-3.0 라이선스(특히, 저작권 공지, PHP-3.0 조건 및 PHP-3.0 권리포기)는 패키지를 통해 복제한다. 그런 공지가 저작권 화면에 생략되었다면 저작권 공지, PHP-3.0 조건 및 PHP-3.0 권리포기사항을 포함하여 전체 PHP-3.0 라이선스가 복제되도록 화면을 수정한다.",
