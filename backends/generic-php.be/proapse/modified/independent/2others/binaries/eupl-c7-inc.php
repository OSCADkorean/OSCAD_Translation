...
$gFbLiSpUcDesc=
	"EUPL로 라이선스 된 받은 프로그램, 어플리케이션 또는 서버(프로앱스)의 수정 버전을 바이너리
...
트 파일을 확장한다.",
		...
		"기존의 EUPL 라이선싱 사항에 포함되는 방식으로 수정사항을 구성한다.",
...
소는 소프트웨어 배포를 지속하는 동안 충분한 기간 동안 온라인에서 사용할 수 있도록 한다.",

		"배포 및 추가 자료에 다운로드 저장소의 힌트를 눈에 띄게 삽입한다.",

		"사용 사례 EUPL-C6의 과업 목록을 실행한다."
);

$gFbLiSpUcRequiresVolArr=array(

		"프로앱스 프로그램의 소스코드의 수정사항을 소스코드 안에 그리고 수정 날짜를 포함하
여 전부 표시한다.",
