...
<translation>
date : 2015.01.14
subject : EPL-C4 : 소스코드로 수정 프로그램 배포
...
*/
	...
	"EPL로 라이선스 된 받은 프로그램, 어플리케이션 또는 서버(proapse)의 수정 버전을 소스코드 파일 형태 또는 소스코드 패키지로 제3자에게 배포하려는 의도를 갖고 있다.";
...
*/
		...
		"받는 사람에게 EPL 1.0 라이선스 사본을 제공한다. 이미 구성한 소프트웨어 패키지의 일부에서 빠져있다면 이를 추가한다.367 패키지의 라이선싱 파일 내 라이선싱 문구에서 패키지가 EPL에 준한다는 설명이 명확하지 않으면 추가로 정확한 EPL 라이선싱 파일을 삽입한다.",
...
*/
		"기존의 EPL-1.0 라이선싱 문구로 적용되는 방식으로 수정물을 구성한다. 만약 새로운 소스코드 파일을 추가했다면, 헤더에 여러분의 저작권을 명시한 문장과 그 문장이 EPL을 충족 시키도록 라이선싱한다는 내용을 추가한다.",
