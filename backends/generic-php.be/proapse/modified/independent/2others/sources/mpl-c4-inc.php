 ...
 *  Etc. Comment : MPL(KOR) -> MPL-2.0(ENG)
 *****************************************************
 */
...
$gOsLicLsucChapter="6.11.4";
$gOsLicTlExplanationChapter="6.11.10";

$gFbLiSpUcName="MPL-2.0-C4";
...
$gFbLiSpUcDesc=
  ...
  "MPL-2.0으로 라이선스 된 받은 프로그램, 어플리케이션 또는 서버 등 프로앱스의 수정 버전을 소스코드 파일 형태 또는 소스코드 패키지로 제3자에게 배포하려는 의도를 갖고 있다.";
...
$gFbLiSpUcRequiresManArr=array(
  ...
  "받는 사람에게 MPL-2.0 라이선스 사본을 제공한다. 이미 구성한 소프트웨어 패키지의 일부에서 빠져있다면 이를 추가한다. 패키지의 라이선싱 파일의 라이선싱 설명에서 MPL-2.0에 의거 패키지를 사용 허가하였다는 점이 명시되지 않으면 다음 문장이 들어간 자체 올바른 MPL-2.0 라이선싱 파일을 추가로 삽입한다. 이 소스코드 형태는 Mozilla Public License 버전 2.0 조항에 준한다. MPL-2.0 사본이 이 파일과 함께 배포되지 않았다면 http://mozilla.org/MPL/2.0/에서 사본 하나를 확보할 수 있다.",
  
  "기존의 MPL-2.0 라이선싱 사항에 포함되는 방식으로 수정물을 구성한다. 만약 새로운 소스코드 파일을 추가했다면, 헤더에 여러분의 저작권을 명시한 문장과 그 문장이 MPL-2.0을 충족하도록 라이선싱한다는 내용을 추가한다."
...
$gFbLiSpUcRequiresVolArr=array(
  ...
  "프로앱스인 프로그램의 소스코드 수정사항을 소스코드 안에 전부 표시한다.",
...
$gFbLiSpUcForbidsArr=array(
		...
		"받은 소프트웨어 패키지 내에 포함된 라이선스 공지(저작권 공지, 특허 공지, 보증 제한 또는 책임배제를 포함)를 삭제하거나 변경",
		
		"사용된 소프트웨어를 공정하게 설명하고 저작권 공지를 복제해야 하는 경우를 제외하고 MPL-2.0 소프트웨어에 연결된 로고, 상표, 서비스 마크로 자신의 제품을 (이 소프트웨어에 근거한) 홍보"
