...
$gOsLicLsucChapter="6.10.4";
$gOsLicTlExplanationChapter="6.10.6";

$gFbLiSpUcName="MIT-C4";

$gFbLiSpUcDesc="사용자가 받은 MIT로 라이선스 된 코드 스니펫, 모듈, 라이브러리 및 플러그인 등 스니몰리의 수정 버전을 이를 바이너리 파일 형태 또는 소스 코드 파일 형태로 제3자에게 배포하려는 의도를 갖고 있다. 그러나 이를 더 큰 소프트웨어 유닛에 삽입하지는 않는다.";
