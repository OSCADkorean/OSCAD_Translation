...
$gFbLiSpUcDesc=
	"사용자가 받은 MIT로 라이선스 된 스니펫, 모듈, 라이브러리 또는 플러그인 등 스니몰리의 수정 버전을 바이너리 형태 또는 소스코드 파일로 제3자에게 내장 컴포넌트로 스니펫, 모듈, 라이브러리 또는 플러그인을 포함하는 다른 더 큰 소프트웨어 유닛과 함께 어떤 형태로든 배포하려는 의도를 갖고 있다.";
