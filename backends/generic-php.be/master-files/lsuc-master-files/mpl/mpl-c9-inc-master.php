...
/*	"that you received an MPL-2.0 licensed code snippet, module, library,
  ...
  "MPL-2.0로 라이선스 된 받은 스니펫, 모듈, 라이브러리 또는 플러그인의 수정 버전을 바이너리 파일 형태 또는 바이너리 패키지로 제3자에게 내장 컴포넌트로서 스니펫, 모듈, 라이브러리 또는 플러그인을 포함하는 다른 더 큰 소프트웨어 유닛과 함께 배포하려는 의도를 갖고 있다.";
...
/*		"Execute the to-do list of use case MPL-2.0-8 (:- the same request parameters,
...
/*		"Organize your modifications of the embedded
		...
		statements."*/
		"기존의 MPL-2.0 라이선싱 사항에 포함되는 방식으로 내장 라이브러리의 수정물을 구성한다."
);
...
/*		"Arrange your binary distribution so that the
		...
		"통합된 MPL-2.0과 라이선싱 파일이 내장 라이브러리만을 명확히 뜻하고 자신의 지배적인 저작물의 라이선싱을 침해하지 않도록 바이너리 배포물을 구성한다. 추가 라이선싱하는 요소가 전부 포함된 특정 디렉토리에 라이브러리, 모듈, 스니펫 또는 플러그인과 같은 삽입된 컴포넌트를 두는 것이 바람직하다.",

/*		"Let the documentation of your distribution and/or
		your additional material  also reproduce the content of the existing
		copyright notice text files, a hint to the name of the used MPL-2.0
