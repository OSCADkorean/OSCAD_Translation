...
$gFbLiSpUcDesc=/*
  ...
  unit.";*/
  "PHP로 라이선스 된 받은 스니펫, 모듈, 라이브러리 또는 플러그인 등 스니몰리의 수정 버전을 바이너리 파일 형태 또는 바이너리 패키지로 제3자에게 배포하려는 의도를 갖고 있다. 단, 이를 다른 더 큰 소프트웨어 유닛에 삽입하지는 않는다.";
...
*/
"전체 PHP 라이선스(특히, 저작권 공지, PHP 조건 및 PHP 권리포기)는 패키지를 통해 복제한다(바이너리로 이 작업이 가능한 한)",
