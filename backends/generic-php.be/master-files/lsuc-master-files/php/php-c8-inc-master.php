...
# Editor : ryu hoon moo <tnsanzz@gmail.com>
...
"배포 문서 및 추가 자료에 “이 제품은 다음의 주소(htp:/www.php.net/)에서 자유로이 이용할 수 있는 PHP를 포함한다”라는 형태로 승인 문구를 포함한다.",
...
" 라이선싱하는 요소(특히, PHP-3.0 라이선스 텍스트, 원저작자 특정 저작권 공지 및 PHP-3.0 권리포기사항)가 내장 라이브러리만을 명확히 가리키고 자신의 지배적인 저작물의 라이선싱을 침해하지 않도록 소스코드 배포물을 구성한다. 모든 라이선싱하는 요소가 들어간 특정 디렉토리에 라이브러리, 모듈, 스니펫 또는 플러그인과 같은 내장 컴포넌트를 두는 것이 바람직하다.");
