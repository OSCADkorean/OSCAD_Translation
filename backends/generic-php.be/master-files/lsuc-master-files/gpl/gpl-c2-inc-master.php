...
are now going to distribute to third parties as an independent unit and in the form of
  ...
  embedded unit.";
*/
    "GPL-2.0 또는 GPL-3.0으로 라이선스 된 받은 소프트웨어의 비수정 버전을 독립 유닛으로 소스코드 파일 형태 또는 소스코드 패키지로 제3자에게 배포하고자 하는 의도를 갖고 있다. 이 경우 프로그램, 어플리케이션, 서버, 스니펫, 모듈, 라이브러리 또는 플러그인 등 배포유형을 식별하는 것은 아니다.";
