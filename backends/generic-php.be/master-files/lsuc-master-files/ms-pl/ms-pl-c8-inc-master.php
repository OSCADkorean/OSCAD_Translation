...
# Etc. Comment : ms-pl-c8 -> ms-pl-c5(binary)
*******************************************************/ 
...
$gOsLicLsucChapter="6.12.8";
$gOsLicTlExplanationChapter="6.12.9";

$gFbLiSpUcName="MS-PL-C8";
...
*/
	...
	"아래에 명시된 금지사항과 상충하지 않는 한, 지배적인 프로그램에 의해 표시되는 저작권 공지에서는 초기에 MS-PL 라이선스에 기반하여 사용 허가된 컴포넌트에 근거한다는 설명을 예를 들어, 원저작물의 프로젝트 홈페이지에 링크하여 밝히는 것이 오픈소스 커뮤니티에서는 바람직한 행위이다." 
);
