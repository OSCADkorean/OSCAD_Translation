...
# Etc. Comment : ms-pl-c4 -> ms-pl-c3(binary)
*******************************************************/   
...
$gOsLicLsucChapter="6.12.4";
$gOsLicTlExplanationChapter="6.12.9";

$gFbLiSpUcName="MS-PL-C4";
...
*/
	...
	"MS-PL로 라이선스 된 받은 프로그램, 어플리케이션 또는 서버 등 프로앱스의 수정 버전을 바이너리 파일 형태 또는 바이너리 패키지로 제3자에게 배포하려는 의도를 갖고 있다.";
...
*/
	...
	"아래에 명시된 금지사항과 상충하지 않는 한, 실행 프로그램에 의해 표시되는 저작권 공지에서는 파생작이 MS-PL 라이선스에 기반하여 사용 허가된 버전에 근거한다는 설명을 예를 들어, 원저작물의 프로젝트 홈페이지에 링크하여 밝히는 것이 오픈소스 커뮤니티에 서는 바람직한 행위이다. 왜냐하면, 프로그램을 수정하고 있기 때문에 초기 저작권 공지에 그 설명이 결여되었다면 그런 힌트를 추가할 수 있다."
);
