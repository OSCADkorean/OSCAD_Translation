...
# Etc. Comment : ms-pl-c5 -> ms-pl-c4(sourcecode)
*******************************************************/ 
...
*/
	...
	"MS-PL로 라이선스 된 받은 스니펫, 모듈, 라이브러리 또는 플러그인 등 스니몰리의 수정 버전을 소스코드 형태로 제3자에게 배포하려는 의도를 갖고 있다. 단, 이를 다른 더 큰 소프트웨어 유닛에 삽입하지는 않는다.";
...
*/
	...
	"MS-PL에 의거 수정물을 공표하고 싶지 않다면 사용한 부분의 초기 요소들로부터 자체 소스와 라이선싱 문서를 깔끔하게 분리한다."
