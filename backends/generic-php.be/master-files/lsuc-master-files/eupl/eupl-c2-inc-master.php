...
$gFbLiSpUcDesc=
	" EUPL로 라이선스  받은 소프트웨어의 비수정 버전을 독립 유닛으로, 소스코드 파일 형태 또는
소스코드 패키지로 제3자에게 배포하고자 하는 의도를 갖고 있다. 이 경우 프로그램, 어플리케이
...
$gFbLiSpUcRequiresVolArr=array(
  " 배포 문서 및 추가 자료를 통해 또한 저작권 공지 텍스트 파일 내용, 소프트웨어 명칭에
대한 힌트, 홈페이지 링크, EUPL-1.1 라이선스 링크를 복제한다."
);
