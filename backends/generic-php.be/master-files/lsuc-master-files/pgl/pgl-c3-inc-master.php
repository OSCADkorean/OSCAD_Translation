...
/*	"that you received a PostgreSQL licensed program, application, or
  ...
  files.";*/
  "사용자가 받은 PostgreSQL로 라이선스 된 프로그램, 어플리케이션 또는 서버 등 프로앱스의 수정 버전을 바이너리 형태 또는 소스코드 파일로 제3자에게 배포하려는 의도를 갖고 있다.";
...
/*		"Ensure that the complete PostgreSQL license including
  ...
  "저작권 공지, 허가 공지 및 PostgreSQL 권리포기사항을 포함하여 PostgreSQL 라이선스를 받았던 형태로 패키지에 전부 보유한다.";
);
...
/*  "You can add information about your own work or
  ...
  "자신의 저작물 또는 수정에 관한 정보가 들어간 프로그램으로 제시되는 기존의 저작권 공지를 확대할 수 있다.",
...
/*  "It is a good practice of the open source
  ...
  "프로그램에 의해 표시되는 저작권 공지는 PostgreSQL 라이선스에 기반하여 초기에 사용 허가된 버전에 근거한다는 설명을 이 공지에서 밝히는 것이 오픈소스 커뮤니티에서는 바람직한 행위이다. 왜냐하면, 프로그램을 수정하는 중이므로, 제시한 초기 저작권 공지에 그러한 설명이 부족하다면 그런 힌트를 추가할 수 있기 때문이다."
);
