...
/*	"that you received PostgreSQL licensed software which you are now going to
  ...
  "사용자가 받은 PGL로 라이선스 된 소프트웨어의 비수정 버전을 바이너리 형태 또는 소스코드 파일로 제3자에게 배포하고자 하는 의도를 갖고 있다.
  이 경우 프로그램, 어플리케이션, 서버, 스니펫, 모듈, 라이브러리, 플러그 또는 독립패키지 등 배포유형을 식별하는 것은 아니다.";

$gFbLiSpUcRequiresPrefix=
/*	"the following tasks in order to fulfill the conditions of the
	 $gFbLicenseSpecification";*/
	 "라이선스를 충족하기 위한 작업은 다음과 같다:";
