...
*/
		...
		"EPL-1.0 라이선스 사본을 받는 사람에게 제공한다. 이미 구성한 소프트웨어 패키지의 일부에서 빠져있다면 이를 추가한다. 패키지의 라이선싱 파일 내 라이선싱 설명 중 이 패키지가 EPL-1.0에 준한다는 설명이 명확하지 않으면, 자체적으로 올바른 EPL-1.0라이선싱 파일을 추가로 삽입한다.",
