...
"LGPL-2.1 및 LGPL-3.0로 라이선스 된 받은 소프트웨어를 단독으로 사용하고 제3자에게 양도하지 않는 의도를 갖고 있다.";
...
/*"You are allowed to use any kind of LGPL-2.1 resp. LGPL-3.0 licensed
	...
	"제3자에게 소프트웨어를 제공하지 않는 한 어떠한 의무가 부과되지 않는 정황에서 어떠한 유형의 LGPL-2.1 및 LGPL-3.0 소프트웨어를 사용할 수 있다.";
