 ...
 *  Etc. Comment : LGPL(KOR) -> LGPL-3.0(ENG)
 *****************************************************
 */
...
"LGPL-3.0으로 라이선스 된 받은 하의 프로앱스인 프로그램, 어플리케이션 또는 서버의 수정 버전을 소스코드 파일 형태 또는 소스코드 패키지로 제3자에게 배포하려는 의도를 갖고 있다.";


$gFbLiSpUcRequiresPrefix=
	/*"the following tasks in order to fulfill the license conditions:";*/
	
	"라이선스 조건을 충족시키기 위해 다음과 같은 업무를 따른다:";
