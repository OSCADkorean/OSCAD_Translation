...
*/
	...
	"아파치-2.0으로 라이선스 된 받은 스니펫, 모듈, 라이브러리 또는 플러그인 등 스니몰리의 수정 버전을 소스코드 파일 형태 또는 소스코드 패키지로 제3자에게 배포하려는 의도를 갖고 있다. 단, 이를 다른 더 큰 소프트웨어 유닛에 삽입하지는 않는다.";
...
/*		
		...
		received."
*/
		"공지 텍스트 파일에 받았던 공지 텍스트 파일 정보를 적어도 전부 포함하도록 한다."
);
...
*/
		...
		"소스코드 내에 모든 수정을 완전히 표시한다. 공지 텍스트 파일이 존재하지 않는다면 작성한다. 공지 텍스트 파일을 수정 설명으로 확장한다.",
