...
*/
	...
	"아파치-2.0으로 라이선스 된 받은 프로그램, 어플리케이션 또는 서버의 수정 버전을 소스코드 파일 형태 또는 소스코드 패키지로 제3자에게 배포하려는 의도를 갖고 있다.";
...
*/
		...
		"제3자 공지가 표시된다면 공지 텍스트 파일을 복제한다. 프로그램이 저작권 다이얼로그를 표시하고 있다면 적절한 방식으로 이를 업데이트 한다.",
...
*/
		"소스코드 내에 모든 수정사항을 완전히 표시한다. 공지 텍스트 파일이 존재하지 않는다면 공지 텍스트 파일에 수정에 대한 설명을 추가한다."
);
