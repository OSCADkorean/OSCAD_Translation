...
$gFbLiSpUcRequiresManArr=array(
		...
		"라이브러리 소스코드 내에 모든 수정을 완전히 표시한다. 공지 텍스트 파일이 없다면 생성시킨다. 수정 설명으로 공지 텍스트 파일을 확장한다"
...
$gFbLiSpUcRequiresVolArr=array(
 ...
 "포함된 아파치 라이선스와 공지 텍스트 파일이 자신이 보유한 지배적인 저작물의 라이선싱을 침해하지 않고 내장 라이브러리만을 명확히 나타내도록 배포할 소스코드를 구성한다. 추가로 모든 라이선싱하는 요소가 들어있는 특정 디렉토리에 라이브러리, 모듈, 스니펫 또는 플러그인을 두는 것이 바람직하다."
);
