...
you combine with other software components in the sense of software
development.";
*/

"소프트웨어 개발이라는 취지로 제3자에게 소스코드 형태로 배포하기 전에 오픈소스 라이브러리, 스니펫 코드, 모듈 또는 플러그인을 수정하여 다른 소프트웨어 컴포넌트와 결합할 의도를 갖고 있다. 구체적으로 라이선스를 충족시키는 과업 목록을 살펴보려면 아래의 안내하는 쪽으로 이동한다.";
