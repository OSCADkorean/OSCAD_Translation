...
"받은 그대로의 소스코드 형태로 제3자에게 수정되지 않은 오픈소스 프로그램, 어플리케이션 또는 서버를 배포할 의도를 갖고 있다. 이와 같은 배포 행위에서는 소프트웨어 개발이라는 취지로 이 프로그램, 어플리케이션 또는 서버를 다른 소프트웨어 컴포넌트와 결합하지 않는다. 구체적으로 라이선스를 충족시키는 과업 목록을 살펴보려면 아래의 안내하는 쪽으로 이동한다.";
