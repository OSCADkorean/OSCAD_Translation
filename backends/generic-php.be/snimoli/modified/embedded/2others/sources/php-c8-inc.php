...
$gFbLiSpUcRequiresManArr=array(
	...
	"배포 문서 및 추가 자료에 “이 제품은 다음의 주소(http://www.php.net/)에서 자유로이 이용할 수 있는 PHP를 포함한다”라는 형태로 승인 문구를 포함한다.",
...
$gFbLiSpUcRequiresVolArr=array(
	"실행 프로그램에 의해 표시되는 저작권 공지에서는 PHP 라이선스에 기반하여 사용 허가된 컴포넌트를 프로그램이 사용한다는 설명을 밝히는 것이 오픈소스 커뮤니티에서는 바람직한 행위이다. 지배적인 프로그램의 저작권 화면을 통해 저작권 공지, PHP 조건 및 PHP 권리포기사항을 포함하여 전체 PHP 라이선스를 복제한다(바이너리 배포 시 요구됨).",
	"소스코드 안에 수정사항을 표시한다.",
