...
<translation>
date : 2015.01.15
subject : MIT-C5 : 내장 컴포넌트로 수정 라이브러리 배포
...
/*
  ...
  files.";
*/
	"MIT로 라이선스 된 받은 스니펫, 모듈, 라이브러리 또는 플러그인 등 스니몰리의 수정 버전을 내장 컴포넌트로 스니펫, 모듈, 라이브러리 또는 플러그인을 포함하는 다른 더 큰 소프트웨어 유닛과 함께 바이너리 형태 또는 소스코드 파일로 이를 배포하는 여부와 관계없이 제3자에게 배포하려는 의도를 갖고 있다."; 
...
"초기 라이선싱하는 요소, 특히 원저작자 특정 저작권 공지, 허가 공지 및 MIT 권리포기 사항이 포함된 MIT 라이선스 텍스트에서 내장 라이브러리만을 명확히 가리키고 자신이 보유한 지배적인 저작물의 라이선싱을 침해하지 않도록 배포물을 구성한다. 모든 라이선싱하는 요소가 들어간 특정 디렉토리에 라이브러리, 모듈, 스니펫 또는 플러그인을 두는 것이 바람직하다."
);
