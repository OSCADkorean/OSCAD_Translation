...
<translation>
date : 2015.01.15
subject : BSD-C8 : 내장 소스코드로 수정 라이브러리 배포
...
"BSD 라이선스 된 받은 스니펫, 모듈, 라이브러리 또는 플러그인 등 스니몰리의 수정 버전을 소스코드 파일 형태 또는 소스코드 패키지로 제3자에게 내장 컴포넌트로서, 스니펫, 모듈, 라이브러리, 또는 플러그인을 포함하는 다른 더 큰 소프트웨어 유닛과 함께 배포하려는 의도를 갖고 있다.";
