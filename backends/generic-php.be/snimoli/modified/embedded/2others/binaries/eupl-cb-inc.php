...
$gFbLiSpUcDesc=
	"EUPL로 라이선스 된 받은 스니펫, 모듈, 라이브러리 또는 플러그인 등 스니몰리의 수정 버전을 바이너리 파일 형태 또는 바이너리 패키지로 제3자에게 내장 컴포넌트로서 스니펫, 모듈, 라이브러리 또는 플러그인을 포함하는 다른 더 큰 소프트웨어 유닛과 함께 배포하려는 의도를 갖고 있다.";
	/*
...
$gFbLiSpUcRequiresManArr=array(
	...
	"기존의 EUPL 라이선싱 사항에 포함되는 방식으로 삽입된 라이브러리의 수정사항을 구성한다.",
