...
$gFbLiSpUcRequiresVolArr=array(
	...
	"초기 라이선싱하는 요소, 특히 원저작자 특정 저작권 공지, 허가 공지 및 PGL 권리포기사항이 들어있는 PGL 라이선스 텍스트가 내장 라이브러리만을 확실히 뜻하고 자신의 지배적인 저작물의 라이선싱을 침해하지 않도록 배포물을 구성한다. 모든 라이선싱하는 요소가 들어간 특정 디렉토리에 라이브러리, 모듈, 스니펫 또는 플러그인을 두는 것이 바람직하다."
/*
