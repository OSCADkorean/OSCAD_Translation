...
$gFbLiSpUcDesc=
  ...
  "EUPL-1.1로 라이선스 된 받은 소프트웨어를 단독으로 사용하고 제3자에게 양도하지 않는 의도를 갖고 있다.";
...
$gFbLiSpUcNoTasks=
	...
	"제3자에게 소프트웨어를 제공하지 않는 한 어떠한 의무가 부과되지 않는 사용 상황에서는 어떠한 유형의 EUPL-1.1 소프트웨어도 사용할 수 있다.";
