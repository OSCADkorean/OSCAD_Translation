...
/*		"If still not existing, integrate an explicit, very	prominently placed
		...
		"만약 배포된 소스코드 패키지 안에 존재하지 않는다면, 매우 두드러지게 '보증 없음'이란 명확한 문구를 포함한다. 이 문구로 모든 소프트웨어 기여자에게 소프트웨어 품질에 대한 책임을 전가하지 않는다는 점을 명확히 한다. 그 다음에 그 파일에 EPL-1.0 법적 책임의 권리포기와 보증 없음 조항을 추가한다.",
...
/*		"to remove or to alter any copyright notices contained within the
		...
		"받은 소프트웨어 패키지 내에 포한된 저작권 공지를 제거 또는 변경.",
