...
/*	"that you received a EUPL-1.1 licensed snippet, module or
  ...
  "EUPL-1.1로 라이선스 된 받은 스니펫, 모듈 또는 라이브러리의 비수정 버전을 더 큰 유닛의 내장 컴포넌트로, 바이너리 파일 형태 또는 바이너리 패키지로 제3자에게 배포하려는 의도를 갖고 있다.";
...
/*		"License your overarching program also under the
		...
		"EUPL-1.1에 의거 지배적인 프로그램의 사용을 허가한다. EUPL-1.1 라이선싱 사항에 포함되는 방식으로 기능 추가 개발물의 바이너리를 구성한다",
