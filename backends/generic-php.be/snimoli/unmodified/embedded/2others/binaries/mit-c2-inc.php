...
/*	"that you received MIT licensed software which you are now going to
  ...
  "MIT로 라이선스 된 받은 소프트웨어의 비수정 버전을 바이너리 형태 또는 소스코드 파일로 제3자에게 배포하고자 하는 의도를 갖고 있다. 이 경우 프로그램, 어플리케이션, 서버, 스니펫, 모듈, 라이브러리, 플러그 또는 독립패키지 등 배포유형을 식별하는 것은 아니다.";
...
/*		"Ensure that the licensing elements
  ...
  "라이선싱하는 요소, 특히 원저작자가 특정한 저작권 공지, 허가 공지 및 MIT 권리포기사항이 포함된 MIT 라이선스 텍스트는 받았던 형태로 패키지에 포함한다."
);
