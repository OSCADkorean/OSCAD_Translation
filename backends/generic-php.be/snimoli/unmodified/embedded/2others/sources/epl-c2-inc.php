...
/*	"that you received EPL-1.0 licensed software which you are now
  ...
  "EPL-1.0로 라이선스 된 받은 소프트웨어의 비수정 버전을 소스코드 파일 형태 또는 소스코드 패키지로 제3자에게 배포하고자 하는 의도를 갖고 있다. 이 경우 독립 또는 내장 유닛으로 프로그램, 어플리케이션, 서버, 스니펫, 모듈, 라이브러리 또는 플러그인 등 배포유형을 식별하는 것은 아니다.";
...
/*		"Ensure that the licensing elements
  ...
  have received them.",*/
  "라이선싱하는 요소 특히, 저작권 공지와 법적 책임 및 보증에 관한 권리포기는 받았던 정확한 형태로 패키지에 포함한다.",
...
/*		"Give the recipient a copy of the EPL-1.0 license. If it is not already
		...
		licensing file.",*/
		"EPL-1.0 라이선스 사본을 받는 사람에게 제공한다. 이미 구성한 소프트웨어 패키지의 일부에서 빠져있다면 이를 추가한다. 패키지의 라이선싱 파일 내 라이선싱 설명 중 이 패키지가 EPL-1.0에 준한다는 설명이 명확하지 않으면, 자체적으로 올바른 EPL-1.0 라이선싱 파일을 추가로 삽입한다.",
...
/*		"to remove or to alter any copyright notices contained within the
		...
		"받은 소프트웨어 패키니 내에 포함된 저작권 공지를 제거 또는 변경.",
/*		"to institute a patent litigation against anyone alleging that this
		 software constitutes patent infringement."*/	//한글판에는 없는 내용
