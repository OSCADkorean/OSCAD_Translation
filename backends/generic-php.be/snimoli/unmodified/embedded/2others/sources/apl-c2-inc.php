...
$gOsLicLsucChapter="6.3.2";
$gOsLicTlExplanationChapter="6.3.10";

$gFbLiSpUcName="Apache-2.0-C2";
...
/*  "that you received Apache-2.0 licensed software which you are now
  ...
  "Apache-2.0로 라이선스 된 받은 소프트웨어의 비수정 버전을 소스코드 파일 형태 또는 소스코드 패키지로 제3자에게 배포하고자 하는 의도를 갖고 있다. 이 경우 독립 또는 내장 유닛으로 프로그램, 어플리케이션, 서버, 스니펫, 모듈, 라이브러리 또는 플러그인 등 배포유형을 식별하는 것은 아니다.";
...
/*	"Give the recipient a copy of the Apache 2.0 license. If
	 it is not already part of the software package, add it.",*/
	  "Apache-2.0 라이선스 사본을 받는 사람에게 제공한다. 이미 구성한 소프트웨어 패키지의 일부에서 빠져있다면 이를 추가한다.",
...
/*	"Ensure that a notice text file is retained in your
	 package in the form you have received it."*/
	 "공지 텍스트 파일은 받았던 형태로 패키지에 포함한다."
);

$gFbLiSpUcRequiresVolArr=array(
/*	"Let the documentation of your distribution and/or your additional
	 material also reproduce the content of the notice text file, a hint to the
	 software name, a link to its homepage, and a link to the Apache 2.0 license"*/
	 "배포 문서 및 추가 자료를 통해 또한 공지 텍스트 파일 내용, 소프트웨어 명칭에 대한 힌트, 홈페이지 링크, Apache-2.0 라이선스 링크를 복제한다."
);
