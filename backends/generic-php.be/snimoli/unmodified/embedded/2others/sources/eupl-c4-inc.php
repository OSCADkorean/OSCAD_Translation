...
$gOsLicLsucChapter="6.7.4";
$gOsLicTlExplanationChapter="6.7.12";

$gFbLiSpUcName="EUPL-1.1-C4";
...
/*	"that you received a EUPL-1.1 licensed snippet, module or
  ...
  "EUPL-1.1로 라이선스 된 받은 스니펫, 모듈 또는 라이브러리의 비수정 버전을 더 큰 유닛의 내장 컴포넌트로, 소스코드 파일 형태 또는 소스코드 패키지로 제3자에게 배포하려는 의도를 갖고 있다.";
...
/*		"License your overarching program also under the
		...
		"EUPL-1.1에 의거 지배적인 프로그램의 사용을 허가한다. (EUPL-1.1 라이선싱 사항에 포함되는 방식으로 기능 추가 개발물의 소스를 구성한다."		
);
...
/*  "Let the documentation of your distribution and/or
  ...
  "배포 물서 및 추가 자료를 통해 또한 기존의 저작권 공지 텍스트 파일 내용, 소프트웨어 명칭에 대한 힌트, 홈페이지 링크, EUPL-1.1 라이선스 링크를 복제한다."
);
