...
are now going to distribute to third parties as an independent unit and in the form of
  ...
  "GPL-2.0 또는 GPL-3.0로 라이선스 된 받은 소프트웨어의 비수정 버전을 독립 유닛으로, 바이너리 파일 형태 또는 바이너리 패키지로 제3자에게 배포하고자 하는 의도를 갖고 있다. 이 경우 프로그램, 어플리케이션, 서버, 스니펫, 모듈, 라이브러리 또는 플러그인 등 배포유형을 식별하는 것은 아니다.";
...
/*  "Ensure that the licensing elements - esp. all
  ...
  "라이선싱하는 요소, 특히 GPL-V2 또는 GPL-V3과 보증 없음을 뜻하는 공지는 받았던 형태로 패키지에 포함한다.",
...
/*  "Make the source code of the distributed software
  ...
  "자신의 권한으로 배포된 소프트웨어는 이를 수정하지 않았더라도 소스코드를 저장소(repository)를 통해 이용할 수 있게 한다. 인터넷 저장소에 소스코드 패키지를 삽입하고 인터넷을통한 다운로드를 허용한다. 코드를 수신하는 방법을 설명하는 배포 패키지에 손쉽게 찾는 설명을 포함한다. 이 저장소는 소프트웨어 패키지 실체를 배포한 후 적어도 3년 동안 온라인에서 사용할 수 있도록 한다.",
