...
<translation>
date : 2015.01.15
subject : PHP-C8 : 바이너리로 비수정 소프트웨어 배포
...
"아파치-2.0으로 라이선스 된 받은 소프트웨어의 비수정 버전을 바이너리 파일 형태 또는 바이너리 패키
지로 제3자에게 배포하려는 의도를 갖고 있다. 이 경우 독립 또는 내장 유닛으로 프로그램, 어플리케이션, 서버, 스니펫, 모듈, 라이브러리 또는 플러그인 등 배포유형을 식별하는 것은 아니다.";
...
/*		
		...
		notice."
*/
		"공지 텍스트 파일은 처음에 받았던 형태로 바이너리 패키지에 보유하거나 포함하도록한다."
);
...
/*
     ...
     notice."
*/
	"제3자 공지가 표시된다면, 특히, 여러분의 저작권 공지를 표시한 자체 저작물의 내장 컴포넌트로서 비수정 아파치 라이선스 라이브러리를 포함하여 배포하는 경우라면 공지 텍스트 파일을 복제한다.",
);
