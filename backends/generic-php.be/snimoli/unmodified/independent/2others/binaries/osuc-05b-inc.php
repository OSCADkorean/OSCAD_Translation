...
"받은 그대로 바이너리 형태로 제3자에게 수정되지 않은 오픈소스 라이브러리, 스니펫 코드, 모듈 또는 플러그인을 배포할 의도를 갖고 있다. 이와 같은 배포 행위에서는 소프트웨어 개발이라는 취지로 이 스니펫 코드, 모듈 또는 플러그인을 다른 소프트웨어 컴포넌트와 결합하지 않는다. 구체적으로 라이선스를 충족시키는 과업 목록을 살펴보려면 아래의 안내하는 쪽으로 이동한다.";
