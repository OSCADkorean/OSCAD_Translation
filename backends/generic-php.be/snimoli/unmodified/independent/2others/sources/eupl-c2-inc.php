 ...
 *  Etc. Comment : EUPL(KOR) -> EUPL-1.1(ENG)
 *****************************************************
 */
...
$gOsLicLsucChapter="6.7.2";
$gOsLicTlExplanationChapter="6.7.12";

$gFbLiSpUcName="EUPL-1.1-C2";
...
$gFbLiSpUcDesc=
  ...
  "EUPL-1.1로 라이선스 된 받은 소프트웨어의 비수정 버전을 독립 유닛으로, 소스코드 파일 형태 또는 소스코드 패키지로 제3자에게 배포하고자 하는 의도를 갖고 있다. 이 경우 프로그램, 어플리케이션, 서버, 스니펫, 모듈, 라이브러리 또는 플러그인 등 배포유형을 식별하는 것은 아니다.";
...
$gFbLiSpUcRequiresVolArr=array(
  ...
  "배포 문서 및 추가 자료를 통해 또한 저작권 공지 텍스트 파일 내용, 소프트웨어 명칭에 대한 힌트, 홈페이지 링크, EUPL-1.1 라이선스 링크를 복제한다."
